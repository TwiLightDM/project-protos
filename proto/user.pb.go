...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x04user\x1a\x1bgoogle/protobuf/empty.proto\"H\n" +
	"\x04User\x12\x0e\n" +
	...
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB1Z/github.com/TwiLightDM/project-protos/proto/userb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	7,  // 12: user.UserService.ListUsers:output_type -> user.ListUsersResponse
	9,  // 13: user.UserService.GetUser:output_type -> user.GetUserResponse
